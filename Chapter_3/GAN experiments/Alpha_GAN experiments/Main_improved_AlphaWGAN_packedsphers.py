...
def my_config():
    ...
    cuda_device = 0
@ex.automain
def main(space_dim, cuda_device, target_points_max, name_choice, latent_dim, connectivity, pac_num, dataset_kind,size_wanted, dataset_include_tumor, sofSparsity, diversity, step_report, generator_activation, dataset_size, dimension_orig, shape, batch_size, num_epochs, noise_dim,in_channels_dim,
