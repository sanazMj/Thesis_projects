...
class DiscriminatorNet(torch.nn.Module):
    ...
    def __init__(self,channels,factor, Kernel_factor,z_dim,num_condition,num_pixels, Minibatch,PacGAN_pacnum, mode_collapse, gen_num):
...
def initialize_models(channels,factor, Kernel_factor,z_dim, num_condition, num_pixels,Minibatch,minibatch_kind,
                      Pack_num,PacGAN_pacnum, mode_collapse, gen_num=0):
    init_pixel = 2
    if Minibatch:
    ...
    varnet = VARNet(channels,factor, Kernel_factor,z_dim, num_condition,num_pixels,minibatch_net, Pack_num)
