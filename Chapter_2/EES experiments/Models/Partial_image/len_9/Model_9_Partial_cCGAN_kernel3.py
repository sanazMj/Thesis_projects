...
def initialize_models(channels,channel_facotr, kernel_factor, z_dim, num_condition, num_pixels,Minibatch, minibatch_kind, packnum,PacGAN_pacnum, mode_collapse, gen_num=0):
    print('num',num_pixels)
    pixels_edge = int(math.sqrt(num_pixels))
    if Minibatch:
