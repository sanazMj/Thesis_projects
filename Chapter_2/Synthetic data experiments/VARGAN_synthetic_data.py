...
def my_config():
    ...
    random_sample = True # If false np.random.randint
...
def main(Model, Model_structure, Model_type, model_kind, mode_collapse, dataset, var_coef, pac_var, num_epochs, batch_size, training_samples, test_samples,
          num_runs,n_mixture, n_features, discr_traing_rolls, test_noise_dim, pac_dim, dir, same_creation_type, minibatch_net):
    ...
    # labels_without_thresh_training = labels_without_thresh_training.reshape(1000,1)
    ...
    for epoch in range(num_epochs):
        ...
        for i, data in enumerate(trainloader):
            ...
            for j in range(discr_traing_rolls):
                ...
                v_error_batch, pred_train, pred_same = train_varnet(v_optim, varnet, criterion, real_data_reshape_list,total_label_diff, real_data , num_var, pac_var, batch_size, n_mixture,same_creation_type)
