...
#
def initialize_models(channels,factor, Kernel_factor,z_dim, num_condition, num_pixels,Minibatch,minibatch_kind, Pack_number):
    init_pixel = 2
    if Minibatch:
    ...
    discriminator = DiscriminatorNet(channels,factor, Kernel_factor,z_dim, num_condition,num_pixels, minibatch_net, Pack_number)
